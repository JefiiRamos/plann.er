...
export function CreatTripPage() {
  ...
  const [emailsToInvate, setEmailsToInvite] = useState([
        ...
        <div className='space-y-4'>
          <div className="h-16 bg-zinc-900 px-4 rounded-xl flex items-center shadow-shape gap-3">
            <div className='flex items-center gap-2 flex-1'>
              ...
              <input disabled = {isGuestsInputOpen} type="text" placeholder="Para onde você vai?" className="bg-transparent text-lg placeholder-zinc-400a outline-none flex-1" />
            </div>
            ...
            <div className="h-16 bg-zinc-900 px-4 rounded-xl flex items-center shadow-shape gap-3">
              <button type='button' onClick={openGuestsModal} className='flex items-center gap-2 flex-1 text-left'>
                ...
                {emailsToInvate.length > 0 ? (
                  <span className='text-zinc-100 text-lg flex-1'>{emailsToInvate.length} pessoa(s) convidada(s)</span>
                ) : (
          ...
          <div className='w-[640px] rounded-xl py-5 px-6 shadow-shape bg-zinc-900 space-y-5'>
            ...
            <form onSubmit={addNewEmailToInvite} className='p-2.5 bg-zinc-950 border border-zinc-800 rounded-lg flex items-center gap-2'>
              <div className='px-2 flex items-center flex-1 gap-2'>
                ...
                className="bg-transparent text-lg placeholder-zinc-400a outline-none flex-1" 
                />
              </div>
